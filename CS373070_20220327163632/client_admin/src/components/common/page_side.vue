<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/volunteer/table" v-show="user_group == '管理员' || $check_action('/volunteer/table')"><span>志愿者</span></el-menu-item>
			<el-menu-item index="/referee/table" v-show="user_group == '管理员' || $check_action('/referee/table')"><span>裁判员</span></el-menu-item>
			<el-menu-item index="/athletes/table" v-show="user_group == '管理员' || $check_action('/athletes/table')"><span>运动员</span></el-menu-item>

						...
						<div class="card">
							...
							<div class="form_register">
								<b-form>
									...
									<!--志愿者-->
									<form_volunteer v-if="form.user_group === '志愿者'" :form="form_sub"></form_volunteer>
									<!--裁判员-->
									<form_referee v-if="form.user_group === '裁判员'" :form="form_sub"></form_referee>
									<!--运动员-->
									<form_athletes v-if="form.user_group === '运动员'" :form="form_sub"></form_athletes>
...
<script>
	...
	/* 志愿者 */
	import form_volunteer from "@/components/diy/form_volunteer";
	/* 裁判员 */
	import form_referee from "@/components/diy/form_referee";
	/* 运动员 */
	import form_athletes from "@/components/diy/form_athletes";

<template>
	<div class="diy_details_box diy_div_volunteer_assignment">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "volunteer_assignment",
					source_field: "volunteer_assignment_id",
					source_id: this.obj["volunteer_assignment_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/volunteer_assignment/set?volunteer_assignment_id=' + _this.obj["volunteer_assignment_id"], {
								praise_len
							}, (res) => {
								if(res.result){

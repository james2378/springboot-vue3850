<template>
	<div class="diy_details_box diy_div_competition_registration">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "competition_registration",
					source_field: "competition_registration_id",
					source_id: this.obj["competition_registration_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/competition_registration/set?competition_registration_id=' + _this.obj["competition_registration_id"], {
								praise_len
							}, (res) => {
								if(res.result){

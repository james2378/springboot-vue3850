<template>
	<div class="diy_details_box diy_div_competition_classification">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "competition_classification",
					source_field: "competition_classification_id",
					source_id: this.obj["competition_classification_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/competition_classification/set?competition_classification_id=' + _this.obj["competition_classification_id"], {
								praise_len
							}, (res) => {
								if(res.result){

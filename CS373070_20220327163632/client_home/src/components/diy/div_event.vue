					...
					<div class="view praise_wrap">
						...
						{{ praiseLen }}
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/competition_registration/edit','add')" @click="to_form('/competition_registration/edit')" >报名比赛 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/referee_allocation/edit','add')" @click="to_form('/referee_allocation/edit')" >裁判分配 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/volunteer_assignment/edit','add')" @click="to_form('/volunteer_assignment/edit')" >志愿者分配 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/event/details','set')" @click="change_praise()" >点赞</button>
